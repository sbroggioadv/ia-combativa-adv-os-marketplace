...
<COWORK>/.dev-adv/.memory-evolver-pending.json. A SKILL `memory-evolver` e a que
...
def main() -> int:
    ...
    state_file = cowork / ".dev-adv" / "cowork-state.json"
    ...
    pending_path = cowork / ".dev-adv" / ".memory-evolver-pending.json"
