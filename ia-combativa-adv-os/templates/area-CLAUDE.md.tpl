...
- Toda produção segue o tom configurado em `<COWORK>/.dev-adv/persona.md` (perfil `{{TOM_VOZ_PERFIL}}`, intensidade {{TOM_VOZ_INTENSIDADE}}/10)
...
**Pasta gerada por:** Plugin `ia-combativa-adv-os` v{{PLUGIN_VERSION}}
