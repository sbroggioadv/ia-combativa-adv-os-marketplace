...
2. Ler `<COWORK>/.dev-adv/.memory-evolver-pending.json` — lista de edicoes que o hook PostToolUse registrou ao longo da semana.
...
Gravar o relatorio em `<COWORK>/.dev-adv/.reports/memoria-<YYYY-MM-DD>.md`.
...
- **Windows:** `schtasks /create /tn "ia-combativa-memoria" /tr "claude --prompt '@atualizacao-memoria.md.tpl'" /sc weekly /d SUN /st 22:00`
