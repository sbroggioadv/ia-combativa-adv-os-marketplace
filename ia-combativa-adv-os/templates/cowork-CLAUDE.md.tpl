...
- **Plugin operacional:** `ia-combativa-adv-os` v{{PLUGIN_VERSION}}
- **Persona:** `<COWORK>/.dev-adv/persona.md` (injetada por hook SessionStart)
- **State:** `<COWORK>/.dev-adv/cowork-state.json`
...
Esta pasta é **gerada e mantida pelo plugin `ia-combativa-adv-os`**. Para reconfigurar:
